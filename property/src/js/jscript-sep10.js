			...
			if(http_req)
			{
			  ...
			  if(http_req.readyState==4)
			  {
				 ...
				 { 	 
					...
					if(Plc_website!="")
					{
						 resultInfoString = "<table width='200' align='center' border='0' cellpadding='5' cellspacing='0'><tr><td align='left'><b>"+Plc_name+"</b></td></tr><tr><td align='left'>"+Plc_formatted_address+"</td></tr><tr><td align='left'><a href='"+Plc_website+"'>"+Plc_website+"</a></td></tr><tr><td align='left'><input type='button' id=\"btnShowRoute_"+Plc_curCtrl+"\" value='Show Route' onclick=\"calcRoute(this,"+Plc_lat+","+Plc_lan+",'"+Plc_name+"')\" ></td></tr></table>";
					}
					 else
					 {
						 resultInfoString = "<table width='200' align='center' border='0' cellpadding='5' cellspacing='0'><tr><td align='left'><b>"+Plc_name+"</b></td></tr><tr><td align='left'>"+Plc_formatted_address+"</td></tr><tr><td align='left'><input type='button' id=\"btnShowRoute_"+Plc_curCtrl+"\" value='Show Route' onclick=\"calcRoute(this,"+Plc_lat+","+Plc_lan+",'"+Plc_name+"')\" ></td></tr></table>";
					 }
