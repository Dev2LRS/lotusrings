...
//********************************************************************************/
	...
	//Comment by Saraswathi to avoid the closing of window when it is clicked outside the popup
	//this.doc.getElementById('lbOverlay').onclick = function() { myLytebox.end(); return true; }
	//Comment by Saraswathi
...
//Ayy-
LyteBox.prototype.enableKeyboardNav = function() { return false ;};
LyteBox.prototype.disableKeyboardNav= function() { return false; };
