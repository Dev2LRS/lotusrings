...
--
-- Host: localhost
-- Generation Time: Oct 02, 2013 at 10:29 PM
...
CREATE TABLE IF NOT EXISTS `tbl_bridge` (
  ...
  `conference_pk_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_bridge_bckup`
--

CREATE TABLE IF NOT EXISTS `tbl_bridge_bckup` (
  `pk_bridge_id` int(11) NOT NULL AUTO_INCREMENT,
  `master_id` int(11) NOT NULL,
  `conference_pk_id` int(11) NOT NULL,
  `bridge_type` enum('b','nb') NOT NULL,
...
--
-- Table structure for table `tbl_bridge_error`
--

CREATE TABLE IF NOT EXISTS `tbl_bridge_error` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pk_bridge_id` int(11) NOT NULL,
  `master_id` int(11) NOT NULL,
  `conference_pk_id` int(11) NOT NULL,
  `bridge_type` enum('b','nb') NOT NULL,
  `service_provider_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_bridge_filtered`
--

CREATE TABLE IF NOT EXISTS `tbl_bridge_filtered` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pk_bridge_id` int(11) NOT NULL,
  `master_id` int(11) NOT NULL,
  `conference_pk_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_conference_bckup`
--

CREATE TABLE IF NOT EXISTS `tbl_conference_bckup` (
  `pk_conference_id` int(11) NOT NULL,
  `master_id` int(11) NOT NULL,
  `service_povider_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `conference_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_conference_error`
--

CREATE TABLE IF NOT EXISTS `tbl_conference_error` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pk_conference_id` int(11) NOT NULL,
  `master_id` int(11) NOT NULL,
  `service_povider_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_conference_filtered`
--

CREATE TABLE IF NOT EXISTS `tbl_conference_filtered` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pk_conference_id` int(11) NOT NULL,
  `master_id` int(11) NOT NULL,
  `service_povider_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_customer_bckup`
--

CREATE TABLE IF NOT EXISTS `tbl_customer_bckup` (
...
CREATE TABLE IF NOT EXISTS `tbl_customer_error` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pk_customer_id` int(11) NOT NULL,
  `service_povider_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Table structure for table `tbl_customer_filtered`
--

CREATE TABLE IF NOT EXISTS `tbl_customer_filtered` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pk_customer_id` int(11) NOT NULL,
  `service_povider_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_pr_data` (
  ...
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `record_status` varchar(200) NOT NULL DEFAULT 'RAW',
...
--
-- Table structure for table `tbl_pr_data_bckup`
--

CREATE TABLE IF NOT EXISTS `tbl_pr_data_bckup` (
  `uniquerowid` int(11) NOT NULL,
  `uniqueconfid` int(11) NOT NULL,
  `confid` varchar(12) NOT NULL,
  `bridgename` varchar(10) NOT NULL,
...
--
-- Table structure for table `tbl_pr_error`
--

CREATE TABLE IF NOT EXISTS `tbl_pr_error` (
...
--
-- Table structure for table `tbl_pr_filtered`
--

CREATE TABLE IF NOT EXISTS `tbl_pr_filtered` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniquerowid` int(11) NOT NULL,
  `uniqueconfid` int(11) NOT NULL,
  `confid` varchar(12) NOT NULL,
