...
if (empty($_REQUEST['end_time']) === false) {
    ...
    if (empty($WhereQuery) === false)
        $WhereQuery .= " AND ";
    $WhereQuery .= " end_time <= '" . date('Y-m-d H:i:s', strtotime($EndTime." 23:59:59")) . "'";
}
...
<tr>
    <td class="red1" align="left" ><h2>Non-Bridge Report</h2></td>
 </tr>
			...
			<form name="Listing" id="Listing" method="POST">
                  ...
                  <table width="100%"class="sortable" align="center" cellpadding="0" cellspacing="0" valign="top"  border="0" style="border:1px solid #CAE1F9;"> 
                      ...
                      <!--               <tr>
                                    ...
                                    <tr> <td colspan="6" height="15"></td></tr>
                                    <tr>                                      
                                        <td  align="center" colspan="7">&nbsp;<input type="button" class="button" value="Search" id="SearchBt"/>&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="Show All" id="Showall" onclick="document.location='list_nonbridge_data.php'"/></td>
                                    </tr>
                                </table>
                            </td>                             
                        </tr>                       
				   ...
				   <table class="sortable" width="100%;" align="center" cellpadding="0" cellspacing="0" valign="top"  border="0" style="border:1px solid #CAE1F9;"> 
                      ...
                      <tr>
                          <td class="summary">&nbsp;Number of Non-Bridges :&nbsp;&nbsp;&nbsp;<b><?php echo intval($BridCount);?></b></td>
                      </tr>   
					   <tr>
                          <td class="summary">&nbsp;Number of Minutes :&nbsp;&nbsp;&nbsp;<b><?php echo intval($totmin);?></b></td>
                      </tr>   
                  </table>
                  <div class="space20"></div>
                      ...
                      <table class="sortable" align="center" cellpadding="2" cellspacing="2" valign="top"  border="0" > 
                        <tr style="background-color:#CAE1F9;">			
                            ...
                            <th align="left" nowrap style="padding-left:5px;" class="sort_this" width="200" sortdata="item_type" >Item Type</th>
                            ...
                            <th align="left" nowrap style="padding-left:5px;" class="sort_this" width="120" sortdata="port_id" >Port Id</th>
