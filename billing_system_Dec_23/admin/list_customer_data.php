...
if($_POST['HdnDel'] == 'yes'){
    ...
    $DeleteQry = "DELETE FROM   tbl_customer_raw WHERE record_id = '$Delid'";
...
?>
				   ...
				   <table class="sortable" width="100%;" align="center" cellpadding="0" cellspacing="0" valign="top"  border="0" style="border:1px solid #CAE1F9;"> 
                      ...
                      <tr>
                          <td class="summary">&nbsp;Number of Customers :&nbsp;&nbsp;&nbsp;<b><?php echo intval($CustCount);?></b></td>
                      </tr>                     
                  </table>
                  <div class="space20"></div>
...
<!--                                            <th colspan="2" style="padding-left:5px;"  width="10%">Action</th>			-->
                        ...
                        $QryGetUsr = "select * from   tbl_customer_raw $WhereQuery";
