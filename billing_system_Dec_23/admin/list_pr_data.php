...
/*if($_POST['HdnDel'] == 'yes'){
    ...
    $DeleteQry = "DELETE FROM  tbl_pr_data_raw WHERE record_id = '$Delid'";
...
if (empty($_REQUEST['startdate']) === false) {
    ...
    $WhereQuery = " connecttime >= '" . date('Y-m-d H:i:s', strtotime($StartDate." 00:00:00")) . "'";
}
if (empty($_REQUEST['enddate']) === false) {
    $EndDate = trim($_REQUEST['enddate']);
    if (empty($WhereQuery) === false)
        $WhereQuery .= " AND ";
    $WhereQuery .= " connecttime <= '" . date('Y-m-d H:i:s', strtotime($EndDate." 23:59:59")) . "'";
}
...
$QryGetCountry = "select DISTINCT(countrycode) from  tbl_pr_data_raw";
...
?>
		...
		<?php                 
						$QryGetSummary = "select SUM(duration) as TotalTime,COUNT(DISTINCT intlclientid) as CustomerCount, COUNT(*) as ConfCount from  tbl_pr_data_raw $WhereQuery";
		...
		?>
                  <table class="sortable" width="100%;" align="center" cellpadding="0" cellspacing="0" valign="top"  border="0" style="border:1px solid #CAE1F9;"> 
                      ...
                      <tr>
                          <td class="summary">&nbsp;Number of Customers :&nbsp;&nbsp;&nbsp;<b><?php echo intval($CustomerCount);?></b></td>
                      </tr>
                      <tr>
...
<!--                                            <th colspan="2" style="padding-left:5px;"  width="10%">Action</th>			-->
                        ...
                        $QryGetUsr = " select * from  tbl_pr_data_raw $WhereQuery";
...

                                {
                                        ...
                                        ?>
                                                ...
                                                <tr bgcolor="<?php echo $display_color?>" >
                                                        ...
                                                        <td  align="center">&nbsp;<?php if($dialedout==0) echo 0;else if($dialedout==1) echo 1;else echo '-';?></td>
                                                        <td  align="center">&nbsp;<?php if($soundbyte==0) echo 0;else if($soundbyte==1) echo 1;else echo '-';?></td>
                                                        <td  align="center">&nbsp;<?php if($prairiesoundbyte==0) echo 0;else if($prairiesoundbyte==1) echo 1;else echo '-';?></td>
