...
$redirect="document.location.href='pr_error_cmp.php?pgnum=$page_to'";
}else
$redirect="document.location.href='pr_error_report.php?pgnum=$page_to'";
if(!empty($_POST['uniquerowid'])){
	...
	$ins_qry=mysql_query("update tbl_pr_error set $fdata where raw_rec_id=$id");
	if($ins_qry){
...
$id=$_GET["errorid"];
$selqry=mysql_query("select * from tbl_pr_error where raw_rec_id=$id");
...
<table width="50%" class='edit_error' align="center" cellpadding="0" cellspacing="0"   border="0"> 
	...
	<tr>
	  ...
	  <tr>
		<td>Dialedout</td>
		<td><input type="text" name='dialedout' id='dialedout' value='<?php echo ord($getarr["dialedout"]);?>'></td>
	  </tr>
	  <tr>
		<td>Soundbyte</td>
		<td><input type="text" name='soundbyte' id='soundbyte' value='<?php echo ord($getarr["soundbyte"]);?>'></td>
	  </tr>
	  <tr>
		<td>Prairiesoundbyte</td>
		<td><input type="text" name='prairiesoundbyte' id='prairiesoundbyte' value='<?php echo ord($getarr["prairiesoundbyte"])?>'></td>
	  </tr>
	  <tr>
		<td>Ani</td>
