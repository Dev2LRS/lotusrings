		...
		<ul id="nav">
				...
				<li><a href="#"><img src="images/pages.png" alt="" />Premiere Conferencing</a>
					<ul>	
						...
						<li><a class="<?php echo $comp_premier;?>" href="pr_error_cmp.php"><img src="images/pages.png" alt="" />Error Record Comparison</a></li>
					</ul>
				...
				<li>
					...
					<ul>	
						...
						<li><a class="<?php echo $comp_global;?>" href="glb_err_cmp.php"><img src="images/pages.png" alt="" />Error Record Comparison</a>
						</li>
					</ul>
				</li>
