...
if($_POST['HdnDel'] == 'yes'){
    ...
    $DeleteQry = "DELETE FROM tbl_conference WHERE record_id = '$Delid'";
                        ...
                        <tr>
                            <td align="center">
                                <table class="sortable" align="center" cellpadding="0" cellspacing="0" valign="top"  border="0"> 
                                    ...
                                    <tr>
                                        <td  align="left" nowrap>&nbsp;Customer Id:&nbsp;<input type="text" name="CustomerId" id="CustomerId" value="<?php echo stripslashes($CustomerId);?>"/></td>
                                        <td  align="left" nowrap>&nbsp;&nbsp;Conference Id:&nbsp;<input type="text" name="ConferenceId" id="ConferenceId" value="<?php echo stripslashes($ConferenceId);?>" /></td>
                                        <td  align="left" nowrap>&nbsp;&nbsp;Resv Begin:&nbsp;<input type="text" name="resv_begin" id="resv_begin" readonly value="<?php echo $ResvBegin;?>"/></td>
                                        <td  align="left" nowrap>&nbsp;&nbsp;Resv End:&nbsp;<input type="text" name="resv_end" id="resv_end" readonly value="<?php echo $ResvEnd;?>"/></td>
									</tr>
                                    <tr> <td colspan="6" height="15"></td></tr>
                                    <tr>
                                        <td  align="center" colspan="5">&nbsp;<input type="button" class="button" value="Search" id="SearchBt"/>&nbsp;&nbsp;&nbsp;<input type="button" class="button" value="Show All" id="Showall" onclick="document.location='list_conference_data.php'"/></td>
                                    </tr>
                                </table>
                            </td>                             
                        </tr> 
...
<!--                                            <th colspan="2" style="padding-left:5px;"  width="10%">Action</th>			-->
                        ...
                        $QryGetUsr = "select * from   tbl_conference $WhereQuery";
...
<script>
    ...
    $('#SearchBt').bind('click',function(){
       if($('#CustomerId').val() == '' && $('#ConferenceId').val() == ''&& $('#resv_begin').val() == ''&& $('#resv_end').val() == '')
        {
            alert('Please enter the values to be searched');
        }
        else if($('#resv_begin').val() != '' && validateUSDate($('#resv_begin').val()) == false)
        {
            alert('Please enter the valid begin date');
        }
        else if($('#resv_end').val() != '' && validateUSDate($('#resv_end').val()) == false)
        {
